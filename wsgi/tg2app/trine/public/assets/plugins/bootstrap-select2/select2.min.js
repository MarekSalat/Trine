!function (t) {
    "undefined" == typeof t.fn.each2 && t.extend(t.fn, {each2: function (e) {
        for (var i = t([0]), s = -1, a = this.length; ++s < a && (i.context = i[0] = this[s]) && e.call(i[0], s, i) !== !1;);
        return this
    }})
}(jQuery), function (t, e) {
    "use strict";
    function i(t) {
        ...
        for (e = "", i = 0, s = t.length; s > i; i++)a = t.charAt(i), e += J[a] || a;
        return e
    }

    function s(t, e) {
        for (var i = 0, s = e.length; s > i; i += 1)if (n(t, e[i]))return i;
        return-1
    }
    ...
    function o(e, i) {
        ...
        for (s = e.split(i), a = 0, n = s.length; n > a; a += 1)s[a] = t.trim(s[a]);
        return s
    }
    ...
    function l(i) {
        ...
        i.on("keydown", function () {
            ...
            var a = t.data(i, s);
            a !== e && i.val() !== a && (t.removeData(i, s), i.trigger("keyup-change"))
        })
    }
    ...
    function f(e) {
        e = t(e)[0];
        var i = 0, s = 0;
        if ("selectionStart"in e)i = e.selectionStart, s = e.selectionEnd - i; else if ("selection"in document) {
            e.focus();
            var a = document.selection.createRange();
            s = document.selection.createRange().text.length, a.moveStart("character", -e.value.length), i = a.text.length - s
        }
    ...
    function v(e) {
        if (!I) {
            ...
            I = t(document.createElement("div")).css({position: "absolute", left: "-10000px", top: "-10000px", display: "none", fontSize: i.fontSize, fontFamily: i.fontFamily, fontStyle: i.fontStyle, fontWeight: i.fontWeight, letterSpacing: i.letterSpacing, textTransform: i.textTransform, whiteSpace: "nowrap"}), I.attr("class", "select2-sizer"), t("body").append(I)
        }
    ...
    function y(e, i, s) {
        var a, n, o = [];
        a = e.attr("class"), a && (a = "" + a, t(a.split(" ")).each2(function () {
    ...
    function b(t, e, s, a) {
        var n = i(t.toUpperCase()).indexOf(i(e.toUpperCase())), o = e.length;
        return 0 > n ? (s.push(a(t)), void 0) : (s.push(a(t.substring(0, n))), s.push("<span class='select2-match'>"), s.push(a(t.substring(n, n + o))), s.push("</span>"), s.push(a(t.substring(n + o, t.length))), void 0)
    }
    ...
    function w(i) {
        var s, a = null, n = i.quietMillis || 100, o = i.url, r = this;
        return function (l) {
            window.clearTimeout(s), s = window.setTimeout(function () {
                var s = i.data, n = o, h = i.transport || t.fn.select2.ajaxDefaults.transport, c = {type: i.type || "GET", cache: i.cache || !1, jsonpCallback: i.jsonpCallback || e, dataType: i.dataType || "json"}, d = t.extend({}, t.fn.select2.ajaxDefaults.params, c);
                s = s ? s.call(r, l.term, l.page, l.context) : null, n = "function" == typeof n ? n.call(r, l.term, l.page, l.context) : n, a && a.abort(), i.params && (t.isFunction(i.params) ? t.extend(d, i.params.call(r)) : t.extend(d, i.params)), t.extend(d, {url: n, dataType: i.dataType, data: s, success: function (t) {
    ...
    function k(e) {
        ...
        var o = a();
        return o.text && (n = o.text, t.isFunction(n) || (i = o.text, n = function (t) {
            return t[i]
        })), function (e) {
            var i, s = e.term, o = {results: []};
            return"" === s ? (e.callback(a()), void 0) : (i = function (a, o) {
                var r, l;
                if (a = a[0], a.children) {
                    r = {};
                    for (l in a)a.hasOwnProperty(l) && (r[l] = a[l]);
                    r.children = [], t(a.children).each2(function (t, e) {
                        i(e, r.children)
    ...
    function C(i) {
        ...
        return function (a) {
            var n = a.term, o = {results: []};
            t(s ? i() : i).each(function () {
                var t = this.text !== e, i = t ? this.text : this;
                ("" === n || a.matcher(n, i)) && o.results.push(t ? this : {id: this, text: this})
            }), a.callback(o)
        }
    }
    ...
    function x(t, i, s, a) {
        var o, r, l, h, c, d = t, u = !1;
        if (!a.createSearchChoice || !a.tokenSeparators || a.tokenSeparators.length < 1)return e;
        for (; ;) {
            for (r = -1, l = 0, h = a.tokenSeparators.length; h > l && (c = a.tokenSeparators[l], r = t.indexOf(c), !(r >= 0)); l++);
            if (0 > r)break;
            if (o = t.substring(0, r), t = t.substring(r + c.length), o.length > 0 && (o = a.createSearchChoice.call(this, o, i), o !== e && null !== o && a.id(o) !== e && null !== a.id(o))) {
    ...
    if (window.Select2 === e) {
        var A, E, F, L, O, I, j, N, U = {x: 0, y: 0}, A = {TAB: 9, ENTER: 13, ESC: 27, SPACE: 32, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40, SHIFT: 16, CTRL: 17, ALT: 18, PAGE_UP: 33, PAGE_DOWN: 34, HOME: 36, END: 35, BACKSPACE: 8, DELETE: 46, isArrow: function (t) {
        ...
        j = t(document), O = function () {
        ...
        }), E = P(Object, {bind: function (t) {
            var e = this;
            return function () {
                t.apply(e, arguments)
            }
        }, init: function (i) {
            var s, n, o, r, c = ".select2-results";
            this.opts = i = this.prepareOpts(i), this.id = i.id, i.element.data("select2") !== e && null !== i.element.data("select2") && i.element.data("select2").destroy(), this.container = this.createContainer(), this.containerId = "s2id_" + (i.element.attr("id") || "autogen" + O()), this.containerSelector = "#" + this.containerId.replace(/([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g, "\\$1"), this.container.attr("id", this.containerId), this.body = d(function () {
                ...
                var n = s.scrollTop();
                a > 0 && 0 >= n - a ? (s.scrollTop(0), m(t)) : 0 > a && s.get(0).scrollHeight - s.scrollTop() + a <= s.height() && (s.scrollTop(s.get(0).scrollHeight - s.height()), m(t))
            ...
            r === e && (r = !1), this.readonly(r), N = N || a(), this.autofocus = i.element.prop("autofocus"), i.element.prop("autofocus", !1), this.autofocus && this.focus(), this.nextSearchTerm = e
        }, destroy: function () {
            ...
            if (a ? (i.query = this.bind(function (t) {
                var i, a, n, o = {results: [], more: !1}, r = t.term;
                n = function (e, i) {
                    var s;
                    e.is("option") ? t.matcher(r, e.text(), e) && i.push(h.optionToData(e)) : e.is("optgroup") && (s = h.optionToData(e), e.children().each2(function (t, e) {
                        n(e, s.children)
                ...
                t(o(e.val(), i.separator)).each(function () {
                    var e = {id: this, text: this}, s = i.tags;
            ...
            i.on("change.select2", this.bind(function () {
                ...
                var t, s = i.prop("disabled");
                s === e && (s = !1), this.enable(!s);
                var t = i.prop("readonly");
                t === e && (t = !1), this.readonly(t), y(this.container, this.opts.element, this.opts.adaptContainerCssClass), this.container.addClass(D(this.opts.containerCssClass)), y(this.dropdown, this.opts.element, this.opts.adaptDropdownCssClass), this.dropdown.addClass(D(this.opts.dropdownCssClass))
            ...
            var e, i = this.containerId, s = "scroll." + i, a = "resize." + i, n = "orientationchange." + i;
            this.container.addClass("select2-dropdown-open").addClass("select2-container-active"), this.clearDropdownAlignmentPreference(), this.dropdown[0] !== this.body().children().last()[0] && this.dropdown.detach().appendTo(this.body()), e = t("#select2-drop-mask"), 0 == e.length && (e = t(document.createElement("div")), e.attr("id", "select2-drop-mask").attr("class", "select2-drop-mask"), e.hide(), e.appendTo(this.body()), e.on("mousedown touchstart click", function (e) {
                ...
                s.length > 0 && (i = s.data("select2"), i.opts.selectOnBlur && i.selectHighlighted({noFocus: !0}), i.close({focus: !1}), e.preventDefault(), e.stopPropagation())
            ...
            if (this.opened()) {
                var e = this.containerId, i = "scroll." + e, s = "resize." + e, a = "orientationchange." + e;
                this.container.parents().add(window).each(function () {
            ...
            var i, a, n = this.findHighlightableChoices();
            return 0 === arguments.length ? s(n.filter(".select2-highlighted")[0], n.get()) : (e >= n.length && (e = n.length - 1), 0 > e && (e = 0), this.removeHighlight(), i = t(n[e]), i.addClass("select2-highlighted"), this.ensureHighlightVisible(), a = i.data("select2-data"), a && this.opts.element.trigger({type: "select2-highlight", val: this.id(a), choice: a}), void 0)
            ...
            var t, e = this.results, i = e.find("li.select2-more-results"), s = this.resultsPage + 1, a = this, n = this.search.val(), o = this.context;
            0 !== i.length && (t = i.offset().top - e.offset().top - e.height(), t <= this.opts.loadMorePadding && (i.addClass("select2-active"), this.opts.query({element: this.opts.element, term: n, page: s, context: o, matcher: this.opts.matcher, callback: this.bind(function (t) {
            ...
            var o, r, l, h = this.search, c = this.results, d = this.opts, u = this, p = h.val(), f = t.data(this.container, "select2-last-term");
            if ((i === !0 || !f || !n(p, f)) && (t.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
                l = ++this.queryCount;
                var m = this.getMaximumSelectionSize();
                if (m >= 1 && (o = this.data(), t.isArray(o) && o.length >= m && M(d.formatSelectionTooBig, "formatSelectionTooBig")))return a("<li class='select2-selection-limit'>" + d.formatSelectionTooBig(m) + "</li>"), void 0;
                if (h.val().length < d.minimumInputLength)return M(d.formatInputTooShort, "formatInputTooShort") ? a("<li class='select2-no-results'>" + d.formatInputTooShort(h.val(), d.minimumInputLength) + "</li>") : a(""), i && this.showSearch && this.showSearch(!0), void 0;
                if (d.maximumInputLength && h.val().length > d.maximumInputLength)return M(d.formatInputTooLong, "formatInputTooLong") ? a("<li class='select2-no-results'>" + d.formatInputTooLong(h.val(), d.maximumInputLength) + "</li>") : a(""), void 0;
                d.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + d.formatSearching() + "</li>"), h.addClass("select2-active"), this.removeHighlight(), r = this.tokenize(), r != e && null != r && h.val(r), this.resultsPage = 1, d.query({element: d.element, term: h.val(), page: this.resultsPage, context: null, matcher: d.matcher, callback: this.bind(function (o) {
                    var r;
                    if (l == this.queryCount) {
                        if (!this.opened())return this.search.removeClass("select2-active"), void 0;
                        if (this.context = o.context === e ? null : o.context, this.opts.createSearchChoice && "" !== h.val() && (r = this.opts.createSearchChoice.call(u, h.val(), o.results), r !== e && null !== r && u.id(r) !== e && null !== u.id(r) && 0 === t(o.results).filter(function () {
                            return n(u.id(this), u.id(r))
                        }).length && o.results.unshift(r)), 0 === o.results.length && M(d.formatNoMatches, "formatNoMatches"))return a("<li class='select2-no-results'>" + d.formatNoMatches(h.val()) + "</li>"), void 0;
                        c.empty(), u.opts.populateResults.call(this, c, o.results, {term: h.val(), page: this.resultsPage, context: null}), o.more === !0 && M(d.formatLoadMore, "formatLoadMore") && (c.append("<li class='select2-more-results'>" + u.opts.escapeMarkup(d.formatLoadMore(this.resultsPage)) + "</li>"), window.setTimeout(function () {
                            u.loadMoreIfNeeded()
            ...
            function i() {
                ...
                if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                    if (i = this.opts.element.attr("style"), i !== e)for (s = i.split(";"), n = 0, o = s.length; o > n; n += 1)if (a = s[n].replace(/\s/g, "").match(/[^-]width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== a && a.length >= 1)return a[1];
        ...
        }}), F = P(E, {createContainer: function () {
            ...
            var i, s, a;
            this.opts.minimumResultsForSearch >= 0 && this.showSearch(!0), this.parent.opening.apply(this, arguments), this.showSearchInput !== !1 && this.search.val(this.focusser.val()), this.search.focus(), i = this.search.get(0), i.createTextRange ? (s = i.createTextRange(), s.collapse(!1), s.select()) : i.setSelectionRange && (a = this.search.val().length, i.setSelectionRange(a, a)), "" === this.search.val() && this.nextSearchTerm != e && (this.search.val(this.nextSearchTerm), this.search.select()), this.focusser.prop("disabled", !0).val(""), this.updateResults(!0), this.opts.element.trigger(t.Event("select2-open"))
        }, close: function (t) {
            ...
            this.opts.minimumResultsForSearch < 0 ? this.showSearch(!1) : this.showSearch(!0), this.selection = e = i.find(".select2-choice"), this.focusser = i.find(".select2-focusser"), this.focusser.attr("id", "s2id_autogen" + O()), t("label[for='" + this.opts.element.attr("id") + "']").attr("for", this.focusser.attr("id")), this.focusser.attr("tabindex", this.elementTabIndex), this.search.on("keydown", this.bind(function (t) {
                if (this.isInterfaceEnabled()) {
                    if (t.which === A.PAGE_UP || t.which === A.PAGE_DOWN)return m(t), void 0;
                    switch (t.which) {
                        case A.UP:
                        case A.DOWN:
                            return this.moveHighlight(t.which === A.UP ? -1 : 1), m(t), void 0;
                        case A.ENTER:
                            return this.selectHighlighted(), m(t), void 0;
                        case A.TAB:
                ...
                if (this.isInterfaceEnabled() && t.which !== A.TAB && !A.isControl(t) && !A.isFunctionKey(t) && t.which !== A.ESC) {
                    if (this.opts.openOnEnter === !1 && t.which === A.ENTER)return m(t), void 0;
                    if (t.which == A.DOWN || t.which == A.UP || t.which == A.ENTER && this.opts.openOnEnter) {
                        if (t.altKey || t.ctrlKey || t.shiftKey || t.metaKey)return;
                        return this.open(), m(t), void 0
                    }
            ...
            if (i) {
                ...
                this.opts.element.val(a ? a.val() : ""), this.selection.find(".select2-chosen").empty(), this.selection.removeData("select2-data"), this.setPlaceholder(), e !== !1 && (this.opts.element.trigger({type: "select2-removed", val: this.id(i), choice: i}), this.triggerChange({removed: i}))
            }
            ...
            return"select" === e.element.get(0).tagName.toLowerCase() ? e.initSelection = function (t, e) {
                ...
                var a = i.val(), o = null;
                e.query({matcher: function (t, i, s) {
                    var r = n(a, e.id(s));
                    return r && (o = s), r
            ...
            if (this.triggerSelect(t)) {
                ...
                this.opts.element.val(this.id(t)), this.updateSelection(t), this.opts.element.trigger({type: "select2-selected", val: this.id(t), choice: t}), this.nextSearchTerm = this.opts.nextSearchTerm(t, this.search.val()), this.close(), e && e.noFocus || this.focusser.focus(), n(i, this.id(t)) || this.triggerChange({added: t, removed: s})
            }
        }, updateSelection: function (t) {
            var i, s, a = this.selection.find(".select2-chosen");
            this.selection.data("select2-data", t), a.empty(), null !== t && (i = this.opts.formatSelection(t, a, this.opts.escapeMarkup)), i !== e && a.append(i), s = this.opts.formatSelectionCssClass(t, a), s !== e && a.addClass(s), this.selection.removeClass("select2-default"), this.opts.allowClear && this.getPlaceholder() !== e && this.container.addClass("select2-allowclear")
        }, val: function () {
            var t, i = !1, s = null, a = this, n = this.data();
            ...
            if (t = arguments[0], arguments.length > 1 && (i = arguments[1]), this.select)this.select.val(t).find(":selected").each2(function (t, e) {
                ...
                if (!t && 0 !== t)return this.clear(i), void 0;
            ...
            var i, s = !1;
            return 0 === arguments.length ? (i = this.selection.data("select2-data"), i == e && (i = null), i) : (arguments.length > 1 && (s = arguments[1]), t ? (i = this.data(), this.opts.element.val(t ? this.id(t) : ""), this.updateSelection(t), s && this.triggerChange({added: t, removed: i})) : this.clear(s), void 0)
        }}), L = P(E, {createContainer: function () {
            ...
            return"select" === e.element.get(0).tagName.toLowerCase() ? e.initSelection = function (t, e) {
                ...
                var a = o(i.val(), e.separator), r = [];
                e.query({matcher: function (i, s, o) {
            ...
            this.selection.on("click", ".select2-search-choice:not(.select2-locked)", function () {
                ...
                if (this.isInterfaceEnabled()) {
                    ++this.keydowns;
                    var i = e.find(".select2-search-choice-focus"), s = i.prev(".select2-search-choice:not(.select2-locked)"), a = i.next(".select2-search-choice:not(.select2-locked)"), n = f(this.search);
                    if (i.length && (t.which == A.LEFT || t.which == A.RIGHT || t.which == A.BACKSPACE || t.which == A.DELETE || t.which == A.ENTER)) {
                        var o = i;
                        return t.which == A.LEFT && s.length ? o = s : t.which == A.RIGHT ? o = a.length ? a : null : t.which === A.BACKSPACE ? (this.unselect(i.first()), this.search.width(10), o = s.length ? s : a) : t.which == A.DELETE ? (this.unselect(i.first()), this.search.width(10), o = a.length ? a : null) : t.which == A.ENTER && (o = null), this.selectChoice(o), m(t), o && o.length || this.open(), void 0
                    }
                    if ((t.which === A.BACKSPACE && 1 == this.keydowns || t.which == A.LEFT) && 0 == n.offset && !n.length)return this.selectChoice(e.find(".select2-search-choice:not(.select2-locked)").last()), m(t), void 0;
                    ...
                    if (t.which !== A.TAB && !A.isControl(t) && !A.isFunctionKey(t) && t.which !== A.BACKSPACE && t.which !== A.ESC) {
                        if (t.which === A.ENTER) {
            ...
            var s, a, n = !i.locked, o = t("<li class='select2-search-choice'>    <div></div>    <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'></a></li>"), r = t("<li class='select2-search-choice select2-locked'><div></div></li>"), l = n ? o : r, h = this.id(i), c = this.getVal();
            s = this.opts.formatSelection(i, l.find("div"), this.opts.escapeMarkup), s != e && l.find("div").replaceWith("<div>" + s + "</div>"), a = this.opts.formatSelectionCssClass(i, l.find("div")), a != e && l.addClass(a), n && l.find(".select2-search-choice-close").on("mousedown", m).on("click dblclick", this.bind(function (e) {
            ...
            if (e = t.data("select2-data")) {
                for (; (i = s(this.id(e), a)) >= 0;)a.splice(i, 1), this.setVal(a), this.select && this.postprocessResults();
                t.remove(), this.opts.element.trigger({type: "removed", val: this.id(e), choice: e}), this.triggerChange({removed: e})
            }
        }, postprocessResults: function (t, e, i) {
            var a = this.getVal(), n = this.results.find(".select2-result"), o = this.results.find(".select2-result-with-children"), r = this;
            n.each2(function (t, e) {
                var i = r.id(e.data("select2-data"));
                s(i, a) >= 0 && (e.addClass("select2-selected"), e.find(".select2-result-selectable").addClass("select2-selected"))
            ...
            var t, e, i, s, a, n = r(this.search);
            t = v(this.search) + 10, e = this.search.offset().left, i = this.selection.width(), s = this.selection.offset().left, a = i - (e - s) - n, t > a && (a = i - n), 40 > a && (a = i - n), 0 >= a && (a = t), this.search.width(Math.floor(a))
        }, getVal: function () {
            var t;
            ...
            for (var e = e.slice(0), t = t.slice(0), i = 0; i < e.length; i++)for (var s = 0; s < t.length; s++)n(this.opts.id(e[i]), this.opts.id(t[s])) && (e.splice(i, 1), i--, t.splice(s, 1), s--);
            return{added: e, removed: t}
        }, val: function (i, s) {
            var a, n = this;
            if (0 === arguments.length)return this.getVal();
            if (a = this.data(), a.length || (a = []), !i && 0 !== i)return this.opts.element.val(""), this.updateSelection([]), this.clearSearch(), s && this.triggerChange({added: this.data(), removed: a}), void 0;
            if (this.setVal(i), this.select)this.opts.initSelection(this.select, this.bind(this.updateSelection)), s && this.triggerChange(this.buildChangeDetails(a, this.data())); else {
                ...
                this.opts.initSelection(this.opts.element, function (e) {
                    var i = t.map(e, n.id);
                    n.setVal(i), n.updateSelection(e), n.clearSearch(), s && n.triggerChange(n.buildChangeDetails(a, this.data()))
                })
            }
            this.clearSearch()
            ...
            var i, a, n, o, r, l = Array.prototype.slice.call(arguments, 0), h = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "search"], c = ["opened", "isFocused", "container", "dropdown"], d = ["val", "data"], u = {search: "externalSearch"};
            return this.each(function () {
                if (0 === l.length || "object" == typeof l[0])i = 0 === l.length ? {} : t.extend({}, l[0]), i.element = t(this), "select" === i.element.get(0).tagName.toLowerCase() ? r = i.element.prop("multiple") : (r = i.multiple || !1, "tags"in i && (i.multiple = r = !0)), a = r ? new L : new F, a.init(i); else {
                    ...
                    if (o = e, a = t(this).data("select2"), a === e)return;
                    if (n = l[0], "container" === n ? o = a.container : "dropdown" === n ? o = a.dropdown : (u[n] && (n = u[n]), o = a[n].apply(a, l.slice(1))), s(l[0], c) >= 0 || s(l[0], d) && 1 == l.length)return!1
                }
            }), o === e ? this : o
        }, t.fn.select2.defaults = {width: "copy", loadMorePadding: 0, closeOnSelect: !0, openOnEnter: !0, containerCss: {}, dropdownCss: {}, containerCssClass: "", dropdownCssClass: "", formatResult: function (t, e, i, s) {
            var a = [];
            return b(t.text, i.term, a, s), a.join("")
            ...
            return"Searching..."
        }, minimumResultsForSearch: 0, minimumInputLength: 0, maximumInputLength: null, maximumSelectionSize: 0, id: function (t) {
            return t.id
        }, matcher: function (t, e) {
            return i("" + e).toUpperCase().indexOf(i("" + t).toUpperCase()) >= 0
        }, separator: ",", tokenSeparators: [], tokenizer: x, escapeMarkup: S, blurOnChange: !1, selectOnBlur: !1, adaptContainerCssClass: function (t) {
            return t
