(function () {
    var ThemeSelector, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
    ...
    ThemeSelector = (function (_super) {
        ...
        ThemeSelector.prototype.events = {'click li': 'handleClick'};
    ...
    $.fn.themeSelector = function (opts) {
        var sel;
        sel = new ThemeSelector($.extend({}, opts, {el: this}));
