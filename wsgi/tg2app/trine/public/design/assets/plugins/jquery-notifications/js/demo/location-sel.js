(function () {
    var LocationSelector, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) {
    ...
    LocationSelector = (function (_super) {
        ...
        LocationSelector.prototype.events = {'click .bit': 'handleClick'};
    ...
    $.fn.locationSelector = function (opts) {
        var loc;
        loc = new LocationSelector($.extend({}, opts, {el: this}));
